...
Route::prefix('dashboard')->middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/logout', [LoginController::class, 'customLogout'])->name('logout-custom');
    Route::get('/get-user-permissions', [getPermissionsController(), 'getCurrentUserPermissions'])->name('admin.user.permissionss');

    Route::prefix('user-profile')->controller(getProfileController())->group(function () {
        Route::get('/', 'getUserProfile')->name('admin.dashboard.user.profile');
        Route::post('/', 'updateUserProfile')->name('admin.dashboard.user.profile.update');
    });
